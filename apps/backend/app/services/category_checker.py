...
_CATEGORY_KEYWORDS = {
    "packaged_food": {"food", "snack", "biscuit", "namkeen", "chocolate", "chips", "juice", "beverage", "sweet", "milk", "butter", "cheese", "paneer", "atta", "dal", "rice", "wheat", "spices", "masala", "edible"},
    "cosmetics": {"cream", "lotion", "soap", "shampoo", "perfume", "deodorant", "powder", "makeup", "lipstick", "nail", "hair", "face", "wash", "moisturizer", "serum"},
    "drugs_pharma": {"tablet", "syrup", "capsule", "ointment", "gel", "injection", "pharmaceutical", "medicine", "rx", "schedule"},
    "textiles": {"cotton", "polyester", "silk", "shirt", "pant", "garment", "wear", "fabric", "textile", "apparel", "clothing"},
}
...
def check_category_mismatch(ocr_text: str, selected_category: str) -> tuple[bool, str | None]:
    ...
    for other_category, keywords in _CATEGORY_KEYWORDS.items():
        ...
        if matched_keywords:
            ...
            warning = f"Category mismatch detected — '{matched_keywords[0]}' suggests {other_name}. Please verify your category selection."
            return True, warning
